...
describe Merchant, type: :model do
  ...
  it ".most_revenue" do
    ...
    invoice_item_2 = create(:invoice_item, quantity: 1, unit_price: 200, invoice: invoice_2, item: item_2)
  ...
  it ".revenue" do 
    ...
    invoice_2 = create(:invoice, merchant: merchant_2, created_at: "2018-08-01 09:00:00 UTC")
    invoice_3 = create(:invoice, merchant: merchant_3, created_at: "2018-08-01 09:00:00 UTC")
    invoice_4 = create(:invoice, merchant: merchant_4, created_at: "2018-08-02 09:00:00 UTC")
    item_1 = create(:item, merchant: merchant_1)
    item_2 = create(:item, merchant: merchant_2)
    item_3 = create(:item, merchant: merchant_3)
    item_4 = create(:item, merchant: merchant_4)
    ...
    # TODO! Strip time
    expect(Merchant.revenue("2018-08-01 09:00:00 UTC")).to eq([merchant_1, merchant_2, merchant_3])
